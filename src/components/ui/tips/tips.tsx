...
export const Tips = component$<TipsProps>(({ id }) => {
  ...
  return (
    <div class="fixed bottom-5 right-5 lg:right-10 z-50">
      {isVisible.value && (
        <div class="fixed flex flex-col bg-neutral-50 shadow-xl h-fit bottom-16 right-0 mx-2 lg-mx-0 lg:w-96 lg:p-0 lg:right-10 border border-neutral-100 rounded-md z-50">
