...
export const ExecutionSidebar = component$(() => {
  ...
  return (
    <aside
      class={cn(
        'fixed top-16 right-6 z-[52] h-screen w-[700px] bg-gradient-to-r from-white to-gray-50 shadow-lg transition-transform duration-200 translate-x-full border border-neutral-200',
        {
