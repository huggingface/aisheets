        ...
        <div class="flex flex-col items-end justify-center gap-1 w-full h-full pr-2">
          <div class="flex flex-col justify-end items-center gap-3 h-full py-2">
            <Button
              ...
              size="sm"
              class={cn(
                'opacity-0 group-hover:opacity-100 transition-opacity visible rounded-full text-white w-4 h-4 bg-neutral-600 p-4 hover:shadow-md shadow-neutral-600',
                {
            ...
            <Button
              ...
              size="sm"
              class={cn(
                'opacity-0 group-hover:opacity-100 transition-opacity visible rounded-full w-4 h-4 text-white bg-neutral-600 p-4 hover:shadow-md shadow-neutral-600',
                {
